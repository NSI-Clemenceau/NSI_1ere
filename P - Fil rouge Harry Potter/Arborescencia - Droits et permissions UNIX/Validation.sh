...
verification_dossiers "SALLE DES POTIONS"
...
verification_fichiers "SALLE DES POTIONS"/PILON.txt
verification_fichiers "SALLE DES POTIONS"/MORTIER.txt
...
nom_fichier="SALLE DES POTIONS/PILON.txt"
droits_corrects="-rwx--xr-x"
verification_droits "$nom_fichier" $droits_corrects

nom_fichier="SALLE DES POTIONS/MORTIER.txt"
droits_corrects="-rwx--xr-x"
verification_droits "$nom_fichier" $droits_corrects
